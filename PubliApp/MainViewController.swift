...
class MainViewController: UIViewController,UITableViewDataSource, UITableViewDelegate, UITabBarControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        lbl.text = "Lo sentimos, en este momento no hay cupones disponibles 🤕"
    ...
    func tabBarController(tabBarController: UITabBarController, didSelectViewController viewController: UIViewController) {
        ...
        if viewController == self {
            if transition == false && offerArray != [] {
            ...
            if error == nil {
                ...
                if error == -1009 {
                    ...
                    if #available(iOS 8.0, *) {
                        ...
                        let alert = UIAlertView(title: "Quau", message: "No hay conectividad", delegate: self, cancelButtonTitle: "OK")
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        cell?.dayNumber.adjustsFontSizeToFitWidth = true
        cell?.dayNumber.sizeToFit()
